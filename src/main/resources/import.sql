--ADMIN
INSERT INTO ADMINS (name,last_name,email,_position) VALUES('admin','admin','admin@gmail.com','employee')
--students
...
--Subjects
INSERT INTO SUBJECT (name,note_one,note_two,note_three,note_four,final_note) VALUES('programming I',0,0,0,0,0)
INSERT INTO SUBJECT (name,note_one,note_two,note_three,note_four,final_note) VALUES('programming II',0,0,0,0,0)
...
INSERT INTO TEACHERS_STUDENTS (teacher_id,students_id) VALUES (1,1)
UPDATE TEACHERS SET user_id=1 WHERE id=1;

INSERT INTO STUDENTS_SUBJECTS (student_id,subjects_id) VALUES(1,1)
INSERT INTO STUDENTS_SUBJECTS (student_id,subjects_id) VALUES(1,2)
